...
<%
	...
	if(AlipayNotify.verifyNotify(params)){//验证成功
		...
		if(trade_status.equals("TRADE_SUCCESS")){
			...
			//String strDescript = $.date(new Date(), "yyyy-MM-dd HH:mm:ss")+"结算订单,订单费用"+csOrder.getCsoPayReal()+"元";
			//ICommonMoneyService moneyService = $.GetSpringBean("commonMoneyService");
			//moneyService.updateMoney(csOrder.getCsoHost(),csMember.getCsmId(),ICommonMoneyService.MoneyType.Money,csOrder.getCsoPayReal(),SYSTEM.RecordType.芝麻信用还款,strDescript,csOrder.getCsoId(),null);
			//moneyService.updateMoney(csOrder.getCsoHost(),csMember.getCsmId(),ICommonMoneyService.MoneyType.Money,-csOrder.getCsoPayReal(),SYSTEM.RecordType.订单消费,strDescript,csOrder.getCsoId(),null);
			...
			out.println("success");	//请不要修改或删除
				//html = "<div class=\"bigmain\"><div class=\"buytitle\"><div class=\"content\"><div class=\"goback\"><a href=\"../reserve.html?from="+from+"\">返回</a></div><div class=\"showtitle\">付款</div></div></div></div>"+
				//		"<div class=\"netbox\"><ul><li class=\"first\"><img src=\"../images/pay-suc.png\">&nbsp;&nbsp;付款成功，感谢您的支持，您可以继续使用租车服务了。</li><li><img src=\"../images/tel.png\">&nbsp;&nbsp;如有疑问请致电客服：0571-88190338</li></ul></div>"+
				//		"<br><div class=\"okbuybtn\"><a href=\"../index.html?from="+from+"\">返回首页</a></div><div class=\"okbuybtn\"><a href=\"../reserve.html?from="+from+"\">立即租车</a></div>";
			//}
