...
<div class="title">
	...
	<a class="linker export" href="shareindex_stats.do?export=true">
		<img align="absmiddle" src="${basePath}admin/images/icons/20088256427828778018.png"/>
		数据导出
	</a>
	<a href="shareindex.do?${lz:querys("UTF-8","")}" class="linker">
		<img align="absmiddle" src="${basePath}admin/images/icons/20088256421631277806.png"/>
		数据管理
	</a>
	...
	<span class="caption">分享指数统计</span>
...
<div class="plate" style="${(hideQuery || (lz:or(window.imize,"maximize"))=="minimize") ? "display:none;":""}">
	<form ref="CsShareIndex" class="query statsForm" id="queryForm" action="shareindex_stats.do" method="post">
		...
		<div class="sum condition">
			...
			<ul>
				...
				<li>
				 	<input ${cssiWebSSum==true?"checked='checked'":""} class="sumBy" type="checkbox" name="sumBy" value="cssiWebS"/>
					网站次数&nbsp;&nbsp;
				</li>
				<li>
				 	<input ${cssiWeiboSSum==true?"checked='checked'":""} class="sumBy" type="checkbox" name="sumBy" value="cssiWeiboS"/>
					微博次数&nbsp;&nbsp;
				</li>
				<li>
				 	<input ${cssiWeixinSSum==true?"checked='checked'":""} class="sumBy" type="checkbox" name="sumBy" value="cssiWeixinS"/>
					微信次数&nbsp;&nbsp;
				</li>
...
$(function(){
	...
	<div class="content">
		...
		stats.datas=[ 
		  	 ...
		  	 ,"cssiWebS":"${lz:digit(item.cssiWebS,2)}"
		  	 ,"cssiWeiboS":"${lz:digit(item.cssiWeiboS,2)}"
		  	 ,"cssiWeixinS":"${lz:digit(item.cssiWeixinS,2)}"
			  <s:iterator value="#request.sumBy" id="sumName" status="i">
			  ${lz:set("array",lz:split(sumName,":"))}${lz:set("arrayCount",lz:size(array))}
