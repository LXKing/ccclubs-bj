...
${get:srvlimit("admin/configurator/provid.do")}
<!------------------------LAZY3Q_JSP_TOP------------------------>
<!------------------------LAZY3Q_JSP_TOP------------------------>

${lz:set("window",lz:window())}
${lz:set("projectpath","admin/configurator/provid.do")}
...
<s:else>
	...
	${lz:set("注释","before$cspPerson和after$cspPerson变量为预留变量，可以上面使用<lz:set name='变量名'>标签注入html代码")}
	<s:if test="#request.CTRL.v.cspPerson==true">
	${before$cspPerson}
	<dl class="cspPerson " major  ref="cspPerson" >
		<dt>负&nbsp;&nbsp;责&nbsp;&nbsp;人:</dt>
		<s:if test="#request.CTRL.e.cspPerson==true">
		${lz:set("haveEditable",true)}
		<dd input="text">
	...
	${lz:set("注释","before$cspConcat和after$cspConcat变量为预留变量，可以上面使用<lz:set name='变量名'>标签注入html代码")}
	<s:if test="#request.CTRL.v.cspConcat==true">
	${before$cspConcat}
	<dl class="cspConcat " major  ref="cspConcat" >
		<dt>联系方式:</dt>
		<s:if test="#request.CTRL.e.cspConcat==true">
		${lz:set("haveEditable",true)}
		<dd input="text">
	...
	${lz:set("注释","before$cspRemark和after$cspRemark变量为预留变量，可以上面使用<lz:set name='变量名'>标签注入html代码")}
	<s:if test="#request.CTRL.v.cspRemark==true">
	${before$cspRemark}
	<dl class="cspRemark " minor  ref="cspRemark" style="width:98%;">
		<dt>备注信息:</dt>
		<s:if test="#request.CTRL.e.cspRemark==true">
		${lz:set("haveEditable",true)}
		<dd input="textarea">
