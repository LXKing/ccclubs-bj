...
<style>
#panel .option .icon{margin-right:20px;}
</style>
...
<s:else>
	<div id="logo">
		<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/admin/flash/swflash.cab#version=7,0,19,0" width="400" height="40">
		  ...
		  <param name="FlashVars" value="TEXT=企业用车服务平台&SIZE=32" />
	...
	<div id="panel">
		<div class="option">
			...
			<a class="icon" onclick="password()" href='javascript:void(0);'>
				<img src="${basePath}admin/images/icons/Keychain.png" />
				<span>修改密码</span>
			</a>
			<a class="icon" onClick="parent.href('map.do','车辆监控')" href='javascript:void(0);'>
				<img src="${basePath}admin/images/icons/GPS.png" />
				<span>车辆监控</span>
			</a>
			<a class="icon" onClick="parent.href('order.do','订单管理')" href='javascript:void(0);'>
				<img src="${basePath}admin/images/icons/200882564216312778012.png" />
				<span>订单管理</span>
			</a>
			<a class="icon" onClick="top.$.open('order.edit.do',{controller:{title:'公务用车'}})" href='javascript:void(0);'>
				<img src="${basePath}admin/images/icons/20088256422923477809.png" />
				<span>创建订单</span>
			</a>
			<a class="icon" onClick="top.$.open('person.edit.do','注册帐号')" href='javascript:void(0);'>
				<img src="${basePath}admin/images/icons/2008112220121595877808.png" />
				<span>注册帐号</span>
			</a>
