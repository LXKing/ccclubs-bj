...
<table id="right-panel" width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
	<tr height="32">
		<td class="state-title">
			<div id="tabframe">
				<table id="tabs" border="0" cellspacing="0" cellpadding="0">
				  <tr id="tabstr"></tr>
				</table>
			</div>		
			<div id="tabmore">
...
var href=function(url,title){
	...
	newHref.table=$("<table class='item state-focus' border='0' cellspacing='0' cellpadding='0'><tr><td class='btn'>"+title+"</td><td class='cls'>x</td></tr></table>");
