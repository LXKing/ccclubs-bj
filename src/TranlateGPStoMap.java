...
//gps坐标转地图坐标算法，纠偏算法。GPS坐标就是传说中大地坐标系统（WGS-84），国内的互联网公司，都不会使用GPS坐标，因为这不符合国家政策。所以大家都会使用GCJ-02坐标系，如腾讯搜搜地图、搜狐搜狗地图、阿里云地图、高德MapABC地图、灵图51ditu地图。百度坐标系统是BD-09。
public class TranlateGPStoMap {
	    ...
	    public static void main(String[] args) {
	    	LatLng ln = toGCJ02Point(39.869825d, 116.305447d);
