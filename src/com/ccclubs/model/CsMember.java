...
public @caption("会员帐号") @table("cs_member") class CsMember implements java.io.Serializable {
    ...
    private @caption("用户名") @column("csm_username") @note("  如果由第三方平台注册，不同类型加前缀") String csmUsername;// 非空
                                                                                                     // 如果由第三方平台注册，不同类型加前缀
    ...
    private @caption("折扣") @column("csm_rebate") @note("  0到1,比如0.75表示七五折") Double csmRebate;// 非空
                                                                                             // 0到1,比如0.75表示七五折
    private @caption("计算营收") @column("csm_not_revenue") @note(" 0:计入营收 1:不计营收  表示该帐号支付的订单是否为营收项") Short csmNotRevenue;// 0:计入营收
                                                                                                                      // 1:不计营收
                                                                                                                      // 表示该帐号支付的订单是否为营收项
    // private @caption("订单记录") @RelateClass(CsOrder.class) List<CsOrder> csmOrders;//反向关联的系统订单列表
    // private @caption("充值记录") @RelateClass(CsAlipayRecord.class) List<CsAlipayRecord>
    // csmAlipays;//反向关联的支付宝充值列表
    // private @caption("使用套餐") @RelateClass(CsUserPack.class) List<CsUserPack>
    // csmPacks;//反向关联的用户套餐列表
    // private @caption("免费小时") @RelateClass(CsFreeHour.class) List<CsFreeHour>
    // csmFreehours;//反向关联的免费小时列表
    ...
    // private @caption("信用账单") @RelateClass(CsCreditBill.class) List<CsCreditBill>
    // csmBills;//反向关联的信用账单列表
    // private @caption("积分记录") @RelateClass(CsIntegralRecord.class) List<CsIntegralRecord>
    // csmIntegrals;//反向关联的积分记录列表
    // private @caption("成长记录") @RelateClass(CsGrowRecord.class) List<CsGrowRecord>
    // csmGrows;//反向关联的成长记录列表
    // private @caption("优惠记录") @RelateClass(CsUseRecord.class) List<CsUseRecord>
    // csmUseRecord;//反向关联的惠免记录列表
    // private @caption("退款记录") @RelateClass(CsRefund.class) List<CsRefund>
    // csmRefounds;//反向关联的会员退款列表
    // private @caption("违章记录") @RelateClass(CsViolat.class) List<CsViolat> csmViolats;//反向关联的车辆违章列表
    // private @caption("事故记录") @RelateClass(CsTrouble.class) List<CsTrouble>
    // csmTroubles;//反向关联的车辆事故列表
    // private @caption("发票记录") @RelateClass(CsInvoice.class) List<CsInvoice>
    // csmInvoices;//反向关联的发票记录列表
    // private @caption("地址管理") @RelateClass(CsAddress.class) List<CsAddress>
    // csmAddresses;//反向关联的会员地址列表
    // private @caption("备忘备注") @RelateClass(CsMemberMemo.class) List<CsMemberMemo>
    // csmMemos;//反向关联的会员备忘列表
    ...
    private @caption("头像") @column("csm_header") @hidden @note(" 200:width 200:height  ") String csmHeader;// 200:width
                                                                                                           // 200:height
    ...
    private @caption("推荐方式") @column("csm_refer_type") @note(" 0:无 1:地址转发 2:微博分享 3:广告媒体 4:网络搜索 5:朋友推荐 6:活动推广  ") Short csmReferType;// 0:无
                                                                                                                                    // 1:地址转发
                                                                                                                                    // 2:微博分享
                                                                                                                                    // 3:广告媒体
                                                                                                                                    // 4:网络搜索
                                                                                                                                    // 5:朋友推荐
                                                                                                                                    // 6:活动推广
    private @caption("注册平台") @column("csm_from") @note(" 0:后台 1:网站 2:微信 3:IOS 4:ANROID 5:OFFICE") Short csmFrom;// 0:后台
                                                                                                                // 1:网站
                                                                                                                // 2:微信
                                                                                                                // 3:APP
                                                                                                                // 4:支付宝微生活
    ...
    private @caption("营销标记") @column("csm_market") @relate("$csmMarket") @RelateClass(SrvProperty.class) @note(" 营销标识:'MEMBER_MARKET'  ") String csmMarket;// 营销标识:'MEMBER_MARKET'
                                                                                                                                                           // select
                                                                                                                                                           // *
                                                                                                                                                           // from
                                                                                                                                                           // srv_property
    ...
    private @caption("会员标签") @column("csm_tag") @relate("$csmTag") @RelateClass(SrvProperty.class) @note(" 用户标签:'MEMBER_TAG'  (会员特性)标签用来对用户分类，在系统属性表中配置") String csmTag;// 用户标签:'MEMBER_TAG'
                                                                                                                                                                        // (会员特性)标签用来对用户分类，在系统属性表中配置
                                                                                                                                                                        // select
                                                                                                                                                                        // *
                                                                                                                                                                        // from
                                                                                                                                                                        // srv_property
    ...
    private @caption("备忘标记") @column("csm_mark") @relate("$csmMark") @RelateClass(SrvProperty.class) @note(" 备忘标记:'MEMBER_MARK'  (管理标记)管理人员对该会员做的备忘标记，在系统属性表中配置") String csmMark;// 备忘标记:'MEMBER_MARK'
                                                                                                                                                                                 // (管理标记)管理人员对该会员做的备忘标记，在系统属性表中配置
                                                                                                                                                                                 // select
                                                                                                                                                                                 // *
                                                                                                                                                                                 // from
                                                                                                                                                                                 // srv_property
    ...
    private @caption("回访标记") @column("csm_visit_flag") @relate("$csmVisitFlag") @RelateClass(CsQuestTemplate.class) @note("  (回访标记)对应回访模板,勾上了表示该模板已调查或已回访") String csmVisitFlag;// (回访标记)对应回访模板,勾上了表示该模板已调查或已回访
                                                                                                                                                                                // select
                                                                                                                                                                                // *
                                                                                                                                                                                // from
                                                                                                                                                                                // cs_quest_template
    ...
    private @caption("程序掩码") @column("csm_mask") @note(" 1:已回流支付宝 2:保留2 4:保留4 8:保留8  (程序标记)技术人员使用的标记，按位运算") Long csmMask;// 1:已回流支付宝
                                                                                                                         // 2:保留2
                                                                                                                         // 4:保留4
                                                                                                                         // 8:保留8
                                                                                                                         // (程序标记)技术人员使用的标记，按位运算
    private @caption("备注") @column("csm_remark") @note("  ") String csmRemark;//
    private @caption("手机认证") @column("csm_v_mobile") @note(" 0:未认证 1:已认证 2:等待认证 3:认证失败  ") Short csmVMobile;// 0:未认证
                                                                                                            // 1:已认证
                                                                                                            // 2:等待认证
                                                                                                            // 3:认证失败
    private @caption("邮箱认证") @column("csm_v_email") @note(" 0:未认证 1:已认证 2:等待认证 3:认证失败  ") Short csmVEmail;// 0:未认证
                                                                                                          // 1:已认证
                                                                                                          // 2:等待认证
                                                                                                          // 3:认证失败
    private @caption("实名认证") @column("csm_v_real") @note(" 0:未认证 1:已认证 2:等待认证 3:认证失败  ") Short csmVReal;// 0:未认证
                                                                                                        // 1:已认证
                                                                                                        // 2:等待认证
                                                                                                        // 3:认证失败
    private @caption("驾驶认证") @column("csm_v_drive") @note(" 0:未认证 1:已认证 2:等待认证 3:认证失败  ") Short csmVDrive;// 0:未认证
                                                                                                          // 1:已认证
                                                                                                          // 2:等待认证
                                                                                                          // 3:认证失败
    private @caption("可用状态") @column("csm_status") @note(" 1:正常 0:禁用  -1:黑名单  ") Short csmStatus;// 非空
                                                                                                 // 0:禁用
                                                                                                 // -1:黑名单;1:正常;2:黑名单;
    private @caption("工作认证") @column("csm_v_work") @note(" 0:未认证 1:已认证 2:等待认证 3:认证失败  ") Short csmVWork;// 0:未认证
                                                                                                        // 1:已认证
                                                                                                        // 2:等待认证
                                                                                                        // 3:认证失败
    private @caption("线下认证") @column("csm_v_offline") @note(" 0:未认证 1:已认证 2:等待认证 3:认证失败  ") Short csmVOffline;// 0:未认证
                                                                                                              // 1:已认证
                                                                                                              // 2:等待认证
                                                                                                              // 3:认证失败
     ...
     * csmVisitFlag,csmMask,csmRemark,csmVMobile,csmVEmail,csmVReal,csmVDrive,csmStatus) CsMember(
     * $.getLong("csmHost")//城市 [非空] ,$.getString("csmUsername")//用户名 [非空]
     * ,$.getString("csmPassword")//帐号密码 [非空] ,$.getLong("csmGroup")//所属组织
     * ,$.getDouble("csmMoney")//余额 [非空] ,$.getDouble("csmCoupon")//现金券 [非空]
     * ,$.getDouble("csmIntegral")//积分 [非空] ,$.getInteger("csmGrow")//成长值 [非空]
     * ,$.getInteger("csmGrade")//会员等级 [非空] ,$.getDouble("csmRebate")//折扣 [非空]
     * ,$.getShort("csmNotRevenue")//计算营收 ,$.getString("csmWeixinFlag")//微信帐号标识
     * ,$.getString("csmAlipayFlag")//支付宝帐号标识 ,$.getString("csmHeader")//头像
     * ,$.getString("csmEmail")//邮箱 ,$.getString("csmMobile")//手机 ,$.getLong("csmEvcard")//EV卡
     * ,$.getString("csmExpress")//快递单号 ,$.getString("csmTemp")//邀请码 ,$.getString("csmName")//真实姓名
     * ,$.getLong("csmInfo")//详细信息 ,$.getLong("csmOutlets")//默认网点 ,$.getShort("csmIsVip")//VIP状态
     * ,$.getDate("csmVipStart")//VIP开始时间 ,$.getDate("csmVipEnd")//VIP结束时间
     * ,$.getDate("csmUpdateTime")//更新时间 ,$.getDate("csmAddTime")//注册时间 [非空]
     * ,$.getDate("csmLastTime")//最后登录 ,$.getString("csmLastIp")//最后登录IP
     * ,$.getInteger("csmLoginS")//登录次数 ,$.getDate("csmFirstUse")//首次用车
     * ,$.getDate("csmLastUse")//最后使用 ,$.getDouble("csmAllRecharge")//累计充值
     * ,$.getLong("csmAllOrderS")//累计订单 ,$.getDouble("csmAllUseTime")//累计用车小时
     * ,$.getLong("csmAllViolatS")//违章次数 ,$.getLong("csmUnViolatS")//未处理违章
     * ,$.getLong("csmAllTroubleS")//事故次数 ,$.getDate("csmFirstRecharge")//首次充值
     * ,$.getDate("csmRefundTime")//最后退款 ,$.getString("csmRegistIp")//注册IP
     * ,$.getLong("csmAdder")//添加人员 ,$.getLong("csmTracker")//跟踪人员 ,$.getLong("csmRefer")//推荐会员
     * ,$.getShort("csmReferType")//推荐方式 ,$.getShort("csmFrom")//注册平台 ,$.getString("csmSrc")//注册源信息
     * ,$.getLong("csmChannel")//来源渠道 ,$.getLong("csmMarketPlan")//营销方案
     * ,$.getLong("csmActivity")//来源活动 ,$.getLong("csmSaler")//销售人员 ,$.getString("csmMarket")//营销标记
     * ,$.getString("csmTag")//会员标签 ,$.getString("csmMark")//备忘标记 ,$.getString("csmVisitFlag")//回访标记
     * ,$.getLong("csmMask")//程序掩码 ,$.getString("csmRemark")//备注 ,$.getShort("csmVMobile")//手机认证
     * ,$.getShort("csmVEmail")//邮箱认证 ,$.getShort("csmVReal")//实名认证 ,$.getShort("csmVDrive")//驾驶认证
     * ,$.getShort("csmStatus")//可用状态 [非空] ,$.getShort("csmVWork")//工作认证
    ...
    public CsMember(Long csmHost, String csmUsername, String csmPassword, Long csmGroup,
            ...
            Date csmAddTime, Date csmLastTime, String csmLastIp, Integer csmLoginS,
            Date csmFirstUse, Date csmLastUse, Double csmAllRecharge, Long csmAllOrderS,
            Double csmAllUseTime, Long csmAllViolatS, Long csmUnViolatS, Long csmAllTroubleS,
            Date csmFirstRecharge, Date csmRefundTime, String csmRegistIp, Long csmAdder,
            Long csmTracker, Long csmRefer, Short csmReferType, Short csmFrom, String csmSrc,
            Long csmChannel, Long csmMarketPlan, Long csmActivity, Long csmSaler, String csmMarket,
            String csmTag, String csmMark, String csmVisitFlag, Long csmMask, String csmRemark,
            Short csmVMobile, Short csmVEmail, Short csmVReal, Short csmVDrive, Short csmStatus,
            Short csmVWork, Short csmVOffline) {
    ...
    // 设置非空字段
    public CsMember setNotNull(Long csmHost, String csmUsername, String csmPassword,
            Double csmMoney, Double csmCoupon, Double csmIntegral, Integer csmGrow,
            Integer csmGrade, Double csmRebate, Date csmAddTime, Short csmStatus) {
        this.csmHost = csmHost;
        this.csmUsername = csmUsername;
        this.csmPassword = csmPassword;
        this.csmMoney = csmMoney;
    ...
    /**
     * 营销标记 [SrvProperty] 营销标识:'MEMBER_MARKET' select * from srv_property where sp_parent = (select
     * sp_id from srv_property where sp_flag = ?)
     **/
    ...
    /**
     * 会员标签 [SrvProperty] 用户标签:'MEMBER_TAG' (会员特性)标签用来对用户分类，在系统属性表中配置 select * from srv_property
     * where sp_parent = (select sp_id from srv_property where sp_flag = ?)
     **/
    ...
    /**
     * 备忘标记 [SrvProperty] 备忘标记:'MEMBER_MARK' (管理标记)管理人员对该会员做的备忘标记，在系统属性表中配置 select * from
     * srv_property where sp_parent = (select sp_id from srv_property where sp_flag = ?)
     **/
    ...
    public static @api CsMember getCsMemberById(Long id) {
        ...
        if (csMember != null)
            return csMember;
        com.ccclubs.service.admin.ICsMemberService csMemberService =
                $.GetSpringBean("csMemberService");
    ...
    public static void updateCsMember(Map set, Map where) {
        if (set.isEmpty())
            throw new RuntimeException("set为空");
        if (where.isEmpty())
            throw new RuntimeException("where为空");
        where.put("confirm", "1");
        com.ccclubs.service.admin.ICsMemberService csMemberService =
                $.GetSpringBean("csMemberService");
    ...
    public SrvHost get$csmHost() {
        com.ccclubs.model.SrvHost srvHost =
                (com.ccclubs.model.SrvHost) $.GetRequest("SrvHost$" + this.getCsmHost());
        if (srvHost != null)
            return srvHost;
        if (this.getCsmHost() != null) {
    ...
    public CsMemberGroup get$csmGroup() {
        com.ccclubs.model.CsMemberGroup csMemberGroup = (com.ccclubs.model.CsMemberGroup) $
                .GetRequest("CsMemberGroup$" + this.getCsmGroup());
    ...
    /******************************* 反向关联的系统订单列表 **********************************/
    /**
     * 获取与当前对象反向关联的系统订单列表 参数size：要取的个数，-1表示取全部
     **/
    public List<CsOrder> getCsmOrders() {
        com.ccclubs.service.admin.ICsOrderService csOrderService =
                $.GetSpringBean("csOrderService");
    ...
    /******************************* 反向关联的支付宝充值列表 **********************************/
    /**
     * 获取与当前对象反向关联的支付宝充值列表 参数size：要取的个数，-1表示取全部
     **/
    public List<CsAlipayRecord> getCsmAlipays() {
        com.ccclubs.service.admin.ICsAlipayRecordService csAlipayRecordService =
                $.GetSpringBean("csAlipayRecordService");
        Map params = new HashMap();
    ...
    /******************************* 反向关联的用户套餐列表 **********************************/
    /**
     * 获取与当前对象反向关联的用户套餐列表 参数size：要取的个数，-1表示取全部
     **/
    public List<CsUserPack> getCsmPacks() {
        com.ccclubs.service.admin.ICsUserPackService csUserPackService =
                $.GetSpringBean("csUserPackService");
        Map params = new HashMap();
    ...
    /******************************* 反向关联的免费小时列表 **********************************/
    /**
     * 获取与当前对象反向关联的免费小时列表 参数size：要取的个数，-1表示取全部
     **/
    public List<CsFreeHour> getCsmFreehours() {
        com.ccclubs.service.admin.ICsFreeHourService csFreeHourService =
                $.GetSpringBean("csFreeHourService");
        Map params = new HashMap();
    ...
    /******************************* 反向关联的列表 **********************************/
    /**
     * 获取与当前对象反向关联的红包列表 参数size：要取的个数，-1表示取全部
     **/
    ...
    /******************************* 反向关联的信用账单列表 **********************************/
    /**
     * 获取与当前对象反向关联的信用账单列表 参数size：要取的个数，-1表示取全部
     **/
    public List<CsCreditBill> getCsmBills() {
        com.ccclubs.service.admin.ICsCreditBillService csCreditBillService =
                $.GetSpringBean("csCreditBillService");
        Map params = new HashMap();
    ...
    /******************************* 反向关联的积分记录列表 **********************************/
    /**
     * 获取与当前对象反向关联的积分记录列表 参数size：要取的个数，-1表示取全部
     **/
    public List<CsIntegralRecord> getCsmIntegrals() {
        com.ccclubs.service.admin.ICsIntegralRecordService csIntegralRecordService =
                $.GetSpringBean("csIntegralRecordService");
        Map params = new HashMap();
        params.put("csrMember", this.getCsmId());
    ...
    /******************************* 反向关联的成长记录列表 **********************************/
    /**
     * 获取与当前对象反向关联的成长记录列表 参数size：要取的个数，-1表示取全部
     **/
    public List<CsGrowRecord> getCsmGrows() {
        com.ccclubs.service.admin.ICsGrowRecordService csGrowRecordService =
                $.GetSpringBean("csGrowRecordService");
        Map params = new HashMap();
    ...
    /******************************* 反向关联的惠免记录列表 **********************************/
    /**
     * 获取与当前对象反向关联的惠免记录列表 参数size：要取的个数，-1表示取全部
     **/
    public List<CsUseRecord> getCsmUseRecord() {
        com.ccclubs.service.admin.ICsUseRecordService csUseRecordService =
                $.GetSpringBean("csUseRecordService");
        Map params = new HashMap();
    ...
    /******************************* 反向关联的会员退款列表 **********************************/
    /**
     * 获取与当前对象反向关联的会员退款列表 参数size：要取的个数，-1表示取全部
     **/
    public List<CsRefund> getCsmRefounds() {
        com.ccclubs.service.admin.ICsRefundService csRefundService =
                $.GetSpringBean("csRefundService");
        Map params = new HashMap();
        params.put("csrMember", this.getCsmId());
    ...
    /******************************* 反向关联的车辆违章列表 **********************************/
    /**
     * 获取与当前对象反向关联的车辆违章列表 参数size：要取的个数，-1表示取全部
     **/
    public List<CsViolat> getCsmViolats() {
        com.ccclubs.service.admin.ICsViolatService csViolatService =
                $.GetSpringBean("csViolatService");
        Map params = new HashMap();
    ...
    /******************************* 反向关联的车辆事故列表 **********************************/
    /**
     * 获取与当前对象反向关联的车辆事故列表 参数size：要取的个数，-1表示取全部
     **/
    public List<CsTrouble> getCsmTroubles() {
        com.ccclubs.service.admin.ICsTroubleService csTroubleService =
                $.GetSpringBean("csTroubleService");
        Map params = new HashMap();
    ...
    /******************************* 反向关联的发票记录列表 **********************************/
    /**
     * 获取与当前对象反向关联的发票记录列表 参数size：要取的个数，-1表示取全部
     **/
    public List<CsInvoice> getCsmInvoices() {
        com.ccclubs.service.admin.ICsInvoiceService csInvoiceService =
                $.GetSpringBean("csInvoiceService");
        Map params = new HashMap();
    ...
    /******************************* 反向关联的会员地址列表 **********************************/
    /**
     * 获取与当前对象反向关联的会员地址列表 参数size：要取的个数，-1表示取全部
     **/
    public List<CsAddress> getCsmAddresses() {
        com.ccclubs.service.admin.ICsAddressService csAddressService =
                $.GetSpringBean("csAddressService");
        Map params = new HashMap();
    ...
    /******************************* 反向关联的会员备忘列表 **********************************/
    /**
     * 获取与当前对象反向关联的会员备忘列表 参数size：要取的个数，-1表示取全部
     **/
    public List<CsMemberMemo> getCsmMemos() {
        com.ccclubs.service.admin.ICsMemberMemoService csMemberMemoService =
                $.GetSpringBean("csMemberMemoService");
        Map params = new HashMap();
    ...
    public CsEvCard get$csmEvcard() {
        com.ccclubs.model.CsEvCard csEvCard =
                (com.ccclubs.model.CsEvCard) $.GetRequest("CsEvCard$" + this.getCsmEvcard());
        if (csEvCard != null)
            return csEvCard;
        if (this.getCsmEvcard() != null) {
    ...
    public CsMemberInfo get$csmInfo() {
        com.ccclubs.model.CsMemberInfo csMemberInfo =
                (com.ccclubs.model.CsMemberInfo) $.GetRequest("CsMemberInfo$" + this.getCsmInfo());
    ...
    public CsOutlets get$csmOutlets() {
        com.ccclubs.model.CsOutlets csOutlets =
                (com.ccclubs.model.CsOutlets) $.GetRequest("CsOutlets$" + this.getCsmOutlets());
        if (csOutlets != null)
            return csOutlets;
        if (this.getCsmOutlets() != null) {
    ...
    public SrvUser get$csmAdder() {
        com.ccclubs.model.SrvUser srvUser =
                (com.ccclubs.model.SrvUser) $.GetRequest("SrvUser$" + this.getCsmAdder());
        if (srvUser != null)
            return srvUser;
        if (this.getCsmAdder() != null) {
    ...
    public SrvUser get$csmTracker() {
        com.ccclubs.model.SrvUser srvUser =
                (com.ccclubs.model.SrvUser) $.GetRequest("SrvUser$" + this.getCsmTracker());
        if (srvUser != null)
            return srvUser;
        if (this.getCsmTracker() != null) {
    ...
    public CsMember get$csmRefer() {
        com.ccclubs.model.CsMember csMember =
                (com.ccclubs.model.CsMember) $.GetRequest("CsMember$" + this.getCsmRefer());
        if (csMember != null)
            return csMember;
        if (this.getCsmRefer() != null) {
    ...
    public CsChannel get$csmChannel() {
        com.ccclubs.model.CsChannel csChannel =
                (com.ccclubs.model.CsChannel) $.GetRequest("CsChannel$" + this.getCsmChannel());
        if (csChannel != null)
            return csChannel;
        if (this.getCsmChannel() != null) {
    ...
    public CsMarketPlan get$csmMarketPlan() {
        com.ccclubs.model.CsMarketPlan csMarketPlan = (com.ccclubs.model.CsMarketPlan) $
                .GetRequest("CsMarketPlan$" + this.getCsmMarketPlan());
    ...
    public CsActivity get$csmActivity() {
        com.ccclubs.model.CsActivity csActivity =
                (com.ccclubs.model.CsActivity) $.GetRequest("CsActivity$" + this.getCsmActivity());
        if (csActivity != null)
            return csActivity;
        if (this.getCsmActivity() != null) {
    ...
    public SrvUser get$csmSaler() {
        com.ccclubs.model.SrvUser srvUser =
                (com.ccclubs.model.SrvUser) $.GetRequest("SrvUser$" + this.getCsmSaler());
        if (srvUser != null)
            return srvUser;
        if (this.getCsmSaler() != null) {
    ...
    public String getCsmMarket$() {
        ...
        if (!$.empty(this.getCsmMarket())) {
            List<com.ccclubs.model.SrvProperty> items =
                    com.ccclubs.model.SrvProperty.getSrvPropertyList($.add("definex",
                            "sp_id in (" + $.str(this.getCsmMarket()).replace("#", "") + ")"), -1);
    ...
    public List<com.ccclubs.model.SrvProperty> get$csmMarket() {
        if (!$.empty(this.getCsmMarket())) {
            return com.ccclubs.model.SrvProperty.getSrvPropertyList($.add("definex",
                    "sp_id in (" + $.str(this.getCsmMarket()).replace("#", "") + ")"), -1);
        } else
    ...
    public String getCsmTag$() {
        ...
        if (!$.empty(this.getCsmTag())) {
            List<com.ccclubs.model.SrvProperty> items =
                    com.ccclubs.model.SrvProperty.getSrvPropertyList(
                            $.add("definex",
                                    "sp_id in (" + $.str(this.getCsmTag()).replace("#", "") + ")"),
                            -1);
            for (com.ccclubs.model.SrvProperty item1 : items)
                strValue += "[" + $.str(item1.getSpName()) + "]";
        }
    ...
    public List<com.ccclubs.model.SrvProperty> get$csmTag() {
        if (!$.empty(this.getCsmTag())) {
            return com.ccclubs.model.SrvProperty.getSrvPropertyList(
                    $.add("definex", "sp_id in (" + $.str(this.getCsmTag()).replace("#", "") + ")"),
                    -1);
        } else
            return new ArrayList();
    }
    ...
    public String getCsmMark$() {
        ...
        if (!$.empty(this.getCsmMark())) {
            List<com.ccclubs.model.SrvProperty> items =
                    com.ccclubs.model.SrvProperty.getSrvPropertyList(
                            $.add("definex",
                                    "sp_id in (" + $.str(this.getCsmMark()).replace("#", "") + ")"),
                            -1);
            for (com.ccclubs.model.SrvProperty item1 : items)
                strValue += "[" + $.str(item1.getSpName()) + "]";
        }
    ...
    public List<com.ccclubs.model.SrvProperty> get$csmMark() {
        if (!$.empty(this.getCsmMark())) {
            return com.ccclubs.model.SrvProperty.getSrvPropertyList($.add("definex",
                    "sp_id in (" + $.str(this.getCsmMark()).replace("#", "") + ")"), -1);
        } else
            return new ArrayList();
    }
    ...
    public String getCsmVisitFlag$() {
        ...
        if (!$.empty(this.getCsmVisitFlag())) {
            List<com.ccclubs.model.CsQuestTemplate> items =
                    com.ccclubs.model.CsQuestTemplate.getCsQuestTemplateList($.add("definex",
                            "csqt_id in (" + $.str(this.getCsmVisitFlag()).replace("#", "") + ")"),
                            -1);
    ...
    public List<com.ccclubs.model.CsQuestTemplate> get$csmVisitFlag() {
        if (!$.empty(this.getCsmVisitFlag())) {
            return com.ccclubs.model.CsQuestTemplate.getCsQuestTemplateList(
                    $.add("definex",
                            "csqt_id in (" + $.str(this.getCsmVisitFlag()).replace("#", "") + ")"),
                    -1);
        } else
    ...
    public String getCsmLockReason$() {
        String strValue = "";
        strValue = $.str(this.getCsmLockReason());
        return strValue;
    }
    ...
    public String getCsmVOfflineCode$() {
        String strValue = "";
        strValue = $.str(this.getCsmVOfflineCode());
        return strValue;
    }
    ...
    public String getVstatus$() {
        String strValue = "";
        int status = this.getVstatus();
        if ($.equals($.str(status), "0"))
            strValue = $.str("未认证");
        if ($.equals($.str(status), "1"))
            strValue = $.str("已认证");
        if ($.equals($.str(status), "2"))
            strValue = $.str("等待认证");
        if ($.equals($.str(status), "3"))
            strValue = $.str("认证失败");
        return strValue;
    }
    ...
    public Map getObj() {
        return new HashMap() {
            ...
            public Object get(Object key) {
                try {
                    return CsMember.class.getMethod("get$" + $.forMat(key.toString()))
                            .invoke(CsMember.this);
                } catch (Exception e) {
                    e.printStackTrace();
                }
                return null;
    ...
    public static class M extends HashMap {
        ...
        /** 编号 [非空] **/
        public M csmId(Object csmId) {
            this.put("csmId", csmId);
            return this;
        };

        /** and csm_id is null */
        public M csmIdNull() {
            if (this.get("csmIdNot") == null)
                this.put("csmIdNot", "");
            this.put("csmId", null);
            return this;
        };
        ...
        /** not .... */
        public M csmIdNot() {
            this.put("csmIdNot", "not");
            return this;
        };

        /** 城市 [非空] [SrvHost] **/
        public M csmHost(Object csmHost) {
            this.put("csmHost", csmHost);
            return this;
        };

        /** and csm_host is null */
        public M csmHostNull() {
            if (this.get("csmHostNot") == null)
                this.put("csmHostNot", "");
            this.put("csmHost", null);
            return this;
        };

        /** not .... */
        public M csmHostNot() {
            this.put("csmHostNot", "not");
            return this;
        };

        /** 用户名 [非空] 如果由第三方平台注册，不同类型加前缀 **/
        public M csmUsername(Object csmUsername) {
            this.put("csmUsername", csmUsername);
            return this;
        };

        /** and csm_username is null */
        public M csmUsernameNull() {
            if (this.get("csmUsernameNot") == null)
                this.put("csmUsernameNot", "");
            this.put("csmUsername", null);
            return this;
        };

        /** not .... */
        public M csmUsernameNot() {
            this.put("csmUsernameNot", "not");
            return this;
        };

        /** 帐号密码 [非空] **/
        public M csmPassword(Object csmPassword) {
            this.put("csmPassword", csmPassword);
            return this;
        };

        /** and csm_password is null */
        public M csmPasswordNull() {
            if (this.get("csmPasswordNot") == null)
                this.put("csmPasswordNot", "");
            this.put("csmPassword", null);
            return this;
        };

        /** not .... */
        public M csmPasswordNot() {
            this.put("csmPasswordNot", "not");
            return this;
        };

        /** 所属组织 [CsMemberGroup] **/
        public M csmGroup(Object csmGroup) {
            this.put("csmGroup", csmGroup);
            return this;
        };

        /** and csm_group is null */
        public M csmGroupNull() {
            if (this.get("csmGroupNot") == null)
                this.put("csmGroupNot", "");
            this.put("csmGroup", null);
            return this;
        };

        /** not .... */
        public M csmGroupNot() {
            this.put("csmGroupNot", "not");
            return this;
        };
        ...
        /** 余额 [非空] **/
        public M csmMoney(Object csmMoney) {
            this.put("csmMoney", csmMoney);
            return this;
        };

        /** and csm_money is null */
        public M csmMoneyNull() {
            if (this.get("csmMoneyNot") == null)
                this.put("csmMoneyNot", "");
            this.put("csmMoney", null);
            return this;
        };

        /** not .... */
        public M csmMoneyNot() {
            this.put("csmMoneyNot", "not");
            return this;
        };

        /** and csm_money >= ? */
        public M csmMoneyMin(Object min) {
            this.put("csmMoneyMin", min);
            return this;
        };

        /** and csm_money <= ? */
        public M csmMoneyMax(Object max) {
            this.put("csmMoneyMax", max);
            return this;
        };

        /** 现金券 [非空] **/
        public M csmCoupon(Object csmCoupon) {
            this.put("csmCoupon", csmCoupon);
            return this;
        };

        /** and csm_coupon is null */
        public M csmCouponNull() {
            if (this.get("csmCouponNot") == null)
                this.put("csmCouponNot", "");
            this.put("csmCoupon", null);
            return this;
        };

        /** not .... */
        public M csmCouponNot() {
            this.put("csmCouponNot", "not");
            return this;
        };

        /** and csm_coupon >= ? */
        public M csmCouponMin(Object min) {
            this.put("csmCouponMin", min);
            return this;
        };

        /** and csm_coupon <= ? */
        public M csmCouponMax(Object max) {
            this.put("csmCouponMax", max);
            return this;
        };

        /** 积分 [非空] **/
        public M csmIntegral(Object csmIntegral) {
            this.put("csmIntegral", csmIntegral);
            return this;
        };

        /** and csm_integral is null */
        public M csmIntegralNull() {
            if (this.get("csmIntegralNot") == null)
                this.put("csmIntegralNot", "");
            this.put("csmIntegral", null);
            return this;
        };

        /** not .... */
        public M csmIntegralNot() {
            this.put("csmIntegralNot", "not");
            return this;
        };

        /** and csm_integral >= ? */
        public M csmIntegralMin(Object min) {
            this.put("csmIntegralMin", min);
            return this;
        };

        /** and csm_integral <= ? */
        public M csmIntegralMax(Object max) {
            this.put("csmIntegralMax", max);
            return this;
        };

        /** 成长值 [非空] **/
        public M csmGrow(Object csmGrow) {
            this.put("csmGrow", csmGrow);
            return this;
        };

        /** and csm_grow is null */
        public M csmGrowNull() {
            if (this.get("csmGrowNot") == null)
                this.put("csmGrowNot", "");
            this.put("csmGrow", null);
            return this;
        };

        /** not .... */
        public M csmGrowNot() {
            this.put("csmGrowNot", "not");
            return this;
        };

        /** and csm_grow >= ? */
        public M csmGrowMin(Object min) {
            this.put("csmGrowMin", min);
            return this;
        };

        /** and csm_grow <= ? */
        public M csmGrowMax(Object max) {
            this.put("csmGrowMax", max);
            return this;
        };

        /** 会员等级 [非空] **/
        public M csmGrade(Object csmGrade) {
            this.put("csmGrade", csmGrade);
            return this;
        };

        /** and csm_grade is null */
        public M csmGradeNull() {
            if (this.get("csmGradeNot") == null)
                this.put("csmGradeNot", "");
            this.put("csmGrade", null);
            return this;
        };

        /** not .... */
        public M csmGradeNot() {
            this.put("csmGradeNot", "not");
            return this;
        };

        /** and csm_grade >= ? */
        public M csmGradeMin(Object min) {
            this.put("csmGradeMin", min);
            return this;
        };

        /** and csm_grade <= ? */
        public M csmGradeMax(Object max) {
            this.put("csmGradeMax", max);
            return this;
        };

        /** 折扣 [非空] 0到1,比如0.75表示七五折 **/
        public M csmRebate(Object csmRebate) {
            this.put("csmRebate", csmRebate);
            return this;
        };

        /** and csm_rebate is null */
        public M csmRebateNull() {
            if (this.get("csmRebateNot") == null)
                this.put("csmRebateNot", "");
            this.put("csmRebate", null);
            return this;
        };

        /** not .... */
        public M csmRebateNot() {
            this.put("csmRebateNot", "not");
            return this;
        };

        /** and csm_rebate >= ? */
        public M csmRebateMin(Object min) {
            this.put("csmRebateMin", min);
            return this;
        };

        /** and csm_rebate <= ? */
        public M csmRebateMax(Object max) {
            this.put("csmRebateMax", max);
            return this;
        };

        /** 计算营收 0:计入营收 1:不计营收 表示该帐号支付的订单是否为营收项 **/
        public M csmNotRevenue(Object csmNotRevenue) {
            this.put("csmNotRevenue", csmNotRevenue);
            return this;
        };

        /** and csm_not_revenue is null */
        public M csmNotRevenueNull() {
            if (this.get("csmNotRevenueNot") == null)
                this.put("csmNotRevenueNot", "");
            this.put("csmNotRevenue", null);
            return this;
        };

        /** not .... */
        public M csmNotRevenueNot() {
            this.put("csmNotRevenueNot", "not");
            return this;
        };

        /** 微信帐号标识 **/
        public M csmWeixinFlag(Object csmWeixinFlag) {
            this.put("csmWeixinFlag", csmWeixinFlag);
            return this;
        };

        /** and csm_weixin_flag is null */
        public M csmWeixinFlagNull() {
            if (this.get("csmWeixinFlagNot") == null)
                this.put("csmWeixinFlagNot", "");
            this.put("csmWeixinFlag", null);
            return this;
        };

        /** not .... */
        public M csmWeixinFlagNot() {
            this.put("csmWeixinFlagNot", "not");
            return this;
        };

        /** 支付宝帐号标识 **/
        public M csmAlipayFlag(Object csmAlipayFlag) {
            this.put("csmAlipayFlag", csmAlipayFlag);
            return this;
        };

        /** and csm_alipay_flag is null */
        public M csmAlipayFlagNull() {
            if (this.get("csmAlipayFlagNot") == null)
                this.put("csmAlipayFlagNot", "");
            this.put("csmAlipayFlag", null);
            return this;
        };

        /** not .... */
        public M csmAlipayFlagNot() {
            this.put("csmAlipayFlagNot", "not");
            return this;
        };

        /** 头像 200:width 200:height **/
        public M csmHeader(Object csmHeader) {
            this.put("csmHeader", csmHeader);
            return this;
        };

        /** and csm_header is null */
        public M csmHeaderNull() {
            if (this.get("csmHeaderNot") == null)
                this.put("csmHeaderNot", "");
            this.put("csmHeader", null);
            return this;
        };

        /** not .... */
        public M csmHeaderNot() {
            this.put("csmHeaderNot", "not");
            return this;
        };

        /** 邮箱 **/
        public M csmEmail(Object csmEmail) {
            this.put("csmEmail", csmEmail);
            return this;
        };

        /** and csm_email is null */
        public M csmEmailNull() {
            if (this.get("csmEmailNot") == null)
                this.put("csmEmailNot", "");
            this.put("csmEmail", null);
            return this;
        };

        /** not .... */
        public M csmEmailNot() {
            this.put("csmEmailNot", "not");
            return this;
        };

        /** 手机 **/
        public M csmMobile(Object csmMobile) {
            this.put("csmMobile", csmMobile);
            return this;
        };

        /** and csm_mobile is null */
        public M csmMobileNull() {
            if (this.get("csmMobileNot") == null)
                this.put("csmMobileNot", "");
            this.put("csmMobile", null);
            return this;
        };

        /** not .... */
        public M csmMobileNot() {
            this.put("csmMobileNot", "not");
            return this;
        };

        /** EV卡 [CsEvCard] **/
        public M csmEvcard(Object csmEvcard) {
            this.put("csmEvcard", csmEvcard);
            return this;
        };

        /** and csm_evcard is null */
        public M csmEvcardNull() {
            if (this.get("csmEvcardNot") == null)
                this.put("csmEvcardNot", "");
            this.put("csmEvcard", null);
            return this;
        };

        /** not .... */
        public M csmEvcardNot() {
            this.put("csmEvcardNot", "not");
            return this;
        };
        ...
        /** 快递单号 **/
        public M csmExpress(Object csmExpress) {
            this.put("csmExpress", csmExpress);
            return this;
        };

        /** and csm_express is null */
        public M csmExpressNull() {
            if (this.get("csmExpressNot") == null)
                this.put("csmExpressNot", "");
            this.put("csmExpress", null);
            return this;
        };

        /** not .... */
        public M csmExpressNot() {
            this.put("csmExpressNot", "not");
            return this;
        };

        /** 邀请码 **/
        public M csmTemp(Object csmTemp) {
            this.put("csmTemp", csmTemp);
            return this;
        };

        /** and csm_temp is null */
        public M csmTempNull() {
            if (this.get("csmTempNot") == null)
                this.put("csmTempNot", "");
            this.put("csmTemp", null);
            return this;
        };

        /** not .... */
        public M csmTempNot() {
            this.put("csmTempNot", "not");
            return this;
        };

        /** 真实姓名 **/
        public M csmName(Object csmName) {
            this.put("csmName", csmName);
            return this;
        };

        /** and csm_name is null */
        public M csmNameNull() {
            if (this.get("csmNameNot") == null)
                this.put("csmNameNot", "");
            this.put("csmName", null);
            return this;
        };

        /** not .... */
        public M csmNameNot() {
            this.put("csmNameNot", "not");
            return this;
        };

        /** 详细信息 [CsMemberInfo] **/
        public M csmInfo(Object csmInfo) {
            this.put("csmInfo", csmInfo);
            return this;
        };

        /** and csm_info is null */
        public M csmInfoNull() {
            if (this.get("csmInfoNot") == null)
                this.put("csmInfoNot", "");
            this.put("csmInfo", null);
            return this;
        };

        /** not .... */
        public M csmInfoNot() {
            this.put("csmInfoNot", "not");
            return this;
        };
        ...
        /** 默认网点 [CsOutlets] ${basePath}${proname}/object/outlets_tree.do?parent={param} **/
        public M csmOutlets(Object csmOutlets) {
            this.put("csmOutlets", csmOutlets);
            return this;
        };

        /** and csm_outlets is null */
        public M csmOutletsNull() {
            if (this.get("csmOutletsNot") == null)
                this.put("csmOutletsNot", "");
            this.put("csmOutlets", null);
            return this;
        };

        /** not .... */
        public M csmOutletsNot() {
            this.put("csmOutletsNot", "not");
            return this;
        };
        ...
        /** VIP状态 0:不是 1:是 **/
        public M csmIsVip(Object csmIsVip) {
            this.put("csmIsVip", csmIsVip);
            return this;
        };

        /** and csm_is_vip is null */
        public M csmIsVipNull() {
            if (this.get("csmIsVipNot") == null)
                this.put("csmIsVipNot", "");
            this.put("csmIsVip", null);
            return this;
        };

        /** not .... */
        public M csmIsVipNot() {
            this.put("csmIsVipNot", "not");
            return this;
        };

        /** VIP开始时间 **/
        public M csmVipStart(Object csmVipStart) {
            this.put("csmVipStart", csmVipStart);
            return this;
        };

        /** and csm_vip_start is null */
        public M csmVipStartNull() {
            if (this.get("csmVipStartNot") == null)
                this.put("csmVipStartNot", "");
            this.put("csmVipStart", null);
            return this;
        };

        /** not .... */
        public M csmVipStartNot() {
            this.put("csmVipStartNot", "not");
            return this;
        };

        /** and csm_vip_start >= ? */
        public M csmVipStartStart(Object start) {
            this.put("csmVipStartStart", start);
            return this;
        };

        /** and csm_vip_start <= ? */
        public M csmVipStartEnd(Object end) {
            this.put("csmVipStartEnd", end);
            return this;
        };

        /** VIP结束时间 **/
        public M csmVipEnd(Object csmVipEnd) {
            this.put("csmVipEnd", csmVipEnd);
            return this;
        };

        /** and csm_vip_end is null */
        public M csmVipEndNull() {
            if (this.get("csmVipEndNot") == null)
                this.put("csmVipEndNot", "");
            this.put("csmVipEnd", null);
            return this;
        };

        /** not .... */
        public M csmVipEndNot() {
            this.put("csmVipEndNot", "not");
            return this;
        };

        /** and csm_vip_end >= ? */
        public M csmVipEndStart(Object start) {
            this.put("csmVipEndStart", start);
            return this;
        };

        /** and csm_vip_end <= ? */
        public M csmVipEndEnd(Object end) {
            this.put("csmVipEndEnd", end);
            return this;
        };

        /** 更新时间 **/
        public M csmUpdateTime(Object csmUpdateTime) {
            this.put("csmUpdateTime", csmUpdateTime);
            return this;
        };

        /** and csm_update_time is null */
        public M csmUpdateTimeNull() {
            if (this.get("csmUpdateTimeNot") == null)
                this.put("csmUpdateTimeNot", "");
            this.put("csmUpdateTime", null);
            return this;
        };

        /** not .... */
        public M csmUpdateTimeNot() {
            this.put("csmUpdateTimeNot", "not");
            return this;
        };

        /** and csm_update_time >= ? */
        public M csmUpdateTimeStart(Object start) {
            this.put("csmUpdateTimeStart", start);
            return this;
        };

        /** and csm_update_time <= ? */
        public M csmUpdateTimeEnd(Object end) {
            this.put("csmUpdateTimeEnd", end);
            return this;
        };

        /** 注册时间 [非空] **/
        public M csmAddTime(Object csmAddTime) {
            this.put("csmAddTime", csmAddTime);
            return this;
        };

        /** and csm_add_time is null */
        public M csmAddTimeNull() {
            if (this.get("csmAddTimeNot") == null)
                this.put("csmAddTimeNot", "");
            this.put("csmAddTime", null);
            return this;
        };

        /** not .... */
        public M csmAddTimeNot() {
            this.put("csmAddTimeNot", "not");
            return this;
        };

        /** and csm_add_time >= ? */
        public M csmAddTimeStart(Object start) {
            this.put("csmAddTimeStart", start);
            return this;
        };

        /** and csm_add_time <= ? */
        public M csmAddTimeEnd(Object end) {
            this.put("csmAddTimeEnd", end);
            return this;
        };

        /** 最后登录 **/
        public M csmLastTime(Object csmLastTime) {
            this.put("csmLastTime", csmLastTime);
            return this;
        };

        /** and csm_last_time is null */
        public M csmLastTimeNull() {
            if (this.get("csmLastTimeNot") == null)
                this.put("csmLastTimeNot", "");
            this.put("csmLastTime", null);
            return this;
        };

        /** not .... */
        public M csmLastTimeNot() {
            this.put("csmLastTimeNot", "not");
            return this;
        };

        /** and csm_last_time >= ? */
        public M csmLastTimeStart(Object start) {
            this.put("csmLastTimeStart", start);
            return this;
        };

        /** and csm_last_time <= ? */
        public M csmLastTimeEnd(Object end) {
            this.put("csmLastTimeEnd", end);
            return this;
        };

        /** 最后登录IP **/
        public M csmLastIp(Object csmLastIp) {
            this.put("csmLastIp", csmLastIp);
            return this;
        };

        /** and csm_last_ip is null */
        public M csmLastIpNull() {
            if (this.get("csmLastIpNot") == null)
                this.put("csmLastIpNot", "");
            this.put("csmLastIp", null);
            return this;
        };

        /** not .... */
        public M csmLastIpNot() {
            this.put("csmLastIpNot", "not");
            return this;
        };

        /** 登录次数 **/
        public M csmLoginS(Object csmLoginS) {
            this.put("csmLoginS", csmLoginS);
            return this;
        };

        /** and csm_login_s is null */
        public M csmLoginSNull() {
            if (this.get("csmLoginSNot") == null)
                this.put("csmLoginSNot", "");
            this.put("csmLoginS", null);
            return this;
        };

        /** not .... */
        public M csmLoginSNot() {
            this.put("csmLoginSNot", "not");
            return this;
        };

        /** and csm_login_s >= ? */
        public M csmLoginSMin(Object min) {
            this.put("csmLoginSMin", min);
            return this;
        };

        /** and csm_login_s <= ? */
        public M csmLoginSMax(Object max) {
            this.put("csmLoginSMax", max);
            return this;
        };

        /** 首次用车 **/
        public M csmFirstUse(Object csmFirstUse) {
            this.put("csmFirstUse", csmFirstUse);
            return this;
        };

        /** and csm_first_use is null */
        public M csmFirstUseNull() {
            if (this.get("csmFirstUseNot") == null)
                this.put("csmFirstUseNot", "");
            this.put("csmFirstUse", null);
            return this;
        };

        /** not .... */
        public M csmFirstUseNot() {
            this.put("csmFirstUseNot", "not");
            return this;
        };

        /** and csm_first_use >= ? */
        public M csmFirstUseStart(Object start) {
            this.put("csmFirstUseStart", start);
            return this;
        };

        /** and csm_first_use <= ? */
        public M csmFirstUseEnd(Object end) {
            this.put("csmFirstUseEnd", end);
            return this;
        };

        /** 最后使用 **/
        public M csmLastUse(Object csmLastUse) {
            this.put("csmLastUse", csmLastUse);
            return this;
        };

        /** and csm_last_use is null */
        public M csmLastUseNull() {
            if (this.get("csmLastUseNot") == null)
                this.put("csmLastUseNot", "");
            this.put("csmLastUse", null);
            return this;
        };

        /** not .... */
        public M csmLastUseNot() {
            this.put("csmLastUseNot", "not");
            return this;
        };

        /** and csm_last_use >= ? */
        public M csmLastUseStart(Object start) {
            this.put("csmLastUseStart", start);
            return this;
        };

        /** and csm_last_use <= ? */
        public M csmLastUseEnd(Object end) {
            this.put("csmLastUseEnd", end);
            return this;
        };

        /** 累计充值 **/
        public M csmAllRecharge(Object csmAllRecharge) {
            this.put("csmAllRecharge", csmAllRecharge);
            return this;
        };

        /** and csm_all_recharge is null */
        public M csmAllRechargeNull() {
            if (this.get("csmAllRechargeNot") == null)
                this.put("csmAllRechargeNot", "");
            this.put("csmAllRecharge", null);
            return this;
        };

        /** not .... */
        public M csmAllRechargeNot() {
            this.put("csmAllRechargeNot", "not");
            return this;
        };

        /** and csm_all_recharge >= ? */
        public M csmAllRechargeMin(Object min) {
            this.put("csmAllRechargeMin", min);
            return this;
        };

        /** and csm_all_recharge <= ? */
        public M csmAllRechargeMax(Object max) {
            this.put("csmAllRechargeMax", max);
            return this;
        };

        /** 累计订单 **/
        public M csmAllOrderS(Object csmAllOrderS) {
            this.put("csmAllOrderS", csmAllOrderS);
            return this;
        };

        /** and csm_all_order_s is null */
        public M csmAllOrderSNull() {
            if (this.get("csmAllOrderSNot") == null)
                this.put("csmAllOrderSNot", "");
            this.put("csmAllOrderS", null);
            return this;
        };

        /** not .... */
        public M csmAllOrderSNot() {
            this.put("csmAllOrderSNot", "not");
            return this;
        };

        /** and csm_all_order_s >= ? */
        public M csmAllOrderSMin(Object min) {
            this.put("csmAllOrderSMin", min);
            return this;
        };

        /** and csm_all_order_s <= ? */
        public M csmAllOrderSMax(Object max) {
            this.put("csmAllOrderSMax", max);
            return this;
        };

        /** 累计用车小时 **/
        public M csmAllUseTime(Object csmAllUseTime) {
            this.put("csmAllUseTime", csmAllUseTime);
            return this;
        };

        /** and csm_all_use_time is null */
        public M csmAllUseTimeNull() {
            if (this.get("csmAllUseTimeNot") == null)
                this.put("csmAllUseTimeNot", "");
            this.put("csmAllUseTime", null);
            return this;
        };

        /** not .... */
        public M csmAllUseTimeNot() {
            this.put("csmAllUseTimeNot", "not");
            return this;
        };

        /** and csm_all_use_time >= ? */
        public M csmAllUseTimeMin(Object min) {
            this.put("csmAllUseTimeMin", min);
            return this;
        };

        /** and csm_all_use_time <= ? */
        public M csmAllUseTimeMax(Object max) {
            this.put("csmAllUseTimeMax", max);
            return this;
        };

        /** 违章次数 **/
        public M csmAllViolatS(Object csmAllViolatS) {
            this.put("csmAllViolatS", csmAllViolatS);
            return this;
        };

        /** and csm_all_violat_s is null */
        public M csmAllViolatSNull() {
            if (this.get("csmAllViolatSNot") == null)
                this.put("csmAllViolatSNot", "");
            this.put("csmAllViolatS", null);
            return this;
        };

        /** not .... */
        public M csmAllViolatSNot() {
            this.put("csmAllViolatSNot", "not");
            return this;
        };

        /** and csm_all_violat_s >= ? */
        public M csmAllViolatSMin(Object min) {
            this.put("csmAllViolatSMin", min);
            return this;
        };

        /** and csm_all_violat_s <= ? */
        public M csmAllViolatSMax(Object max) {
            this.put("csmAllViolatSMax", max);
            return this;
        };

        /** 未处理违章 **/
        public M csmUnViolatS(Object csmUnViolatS) {
            this.put("csmUnViolatS", csmUnViolatS);
            return this;
        };

        /** and csm_un_violat_s is null */
        public M csmUnViolatSNull() {
            if (this.get("csmUnViolatSNot") == null)
                this.put("csmUnViolatSNot", "");
            this.put("csmUnViolatS", null);
            return this;
        };

        /** not .... */
        public M csmUnViolatSNot() {
            this.put("csmUnViolatSNot", "not");
            return this;
        };

        /** and csm_un_violat_s >= ? */
        public M csmUnViolatSMin(Object min) {
            this.put("csmUnViolatSMin", min);
            return this;
        };

        /** and csm_un_violat_s <= ? */
        public M csmUnViolatSMax(Object max) {
            this.put("csmUnViolatSMax", max);
            return this;
        };

        /** 事故次数 **/
        public M csmAllTroubleS(Object csmAllTroubleS) {
            this.put("csmAllTroubleS", csmAllTroubleS);
            return this;
        };

        /** and csm_all_trouble_s is null */
        public M csmAllTroubleSNull() {
            if (this.get("csmAllTroubleSNot") == null)
                this.put("csmAllTroubleSNot", "");
            this.put("csmAllTroubleS", null);
            return this;
        };

        /** not .... */
        public M csmAllTroubleSNot() {
            this.put("csmAllTroubleSNot", "not");
            return this;
        };

        /** and csm_all_trouble_s >= ? */
        public M csmAllTroubleSMin(Object min) {
            this.put("csmAllTroubleSMin", min);
            return this;
        };

        /** and csm_all_trouble_s <= ? */
        public M csmAllTroubleSMax(Object max) {
            this.put("csmAllTroubleSMax", max);
            return this;
        };

        /** 首次充值 **/
        public M csmFirstRecharge(Object csmFirstRecharge) {
            this.put("csmFirstRecharge", csmFirstRecharge);
            return this;
        };

        /** and csm_first_recharge is null */
        public M csmFirstRechargeNull() {
            if (this.get("csmFirstRechargeNot") == null)
                this.put("csmFirstRechargeNot", "");
            this.put("csmFirstRecharge", null);
            return this;
        };

        /** not .... */
        public M csmFirstRechargeNot() {
            this.put("csmFirstRechargeNot", "not");
            return this;
        };

        /** and csm_first_recharge >= ? */
        public M csmFirstRechargeStart(Object start) {
            this.put("csmFirstRechargeStart", start);
            return this;
        };

        /** and csm_first_recharge <= ? */
        public M csmFirstRechargeEnd(Object end) {
            this.put("csmFirstRechargeEnd", end);
            return this;
        };

        /** 最后退款 **/
        public M csmRefundTime(Object csmRefundTime) {
            this.put("csmRefundTime", csmRefundTime);
            return this;
        };

        /** and csm_refund_time is null */
        public M csmRefundTimeNull() {
            if (this.get("csmRefundTimeNot") == null)
                this.put("csmRefundTimeNot", "");
            this.put("csmRefundTime", null);
            return this;
        };

        /** not .... */
        public M csmRefundTimeNot() {
            this.put("csmRefundTimeNot", "not");
            return this;
        };

        /** and csm_refund_time >= ? */
        public M csmRefundTimeStart(Object start) {
            this.put("csmRefundTimeStart", start);
            return this;
        };

        /** and csm_refund_time <= ? */
        public M csmRefundTimeEnd(Object end) {
            this.put("csmRefundTimeEnd", end);
            return this;
        };

        /** 注册IP **/
        public M csmRegistIp(Object csmRegistIp) {
            this.put("csmRegistIp", csmRegistIp);
            return this;
        };

        /** and csm_regist_ip is null */
        public M csmRegistIpNull() {
            if (this.get("csmRegistIpNot") == null)
                this.put("csmRegistIpNot", "");
            this.put("csmRegistIp", null);
            return this;
        };

        /** not .... */
        public M csmRegistIpNot() {
            this.put("csmRegistIpNot", "not");
            return this;
        };

        /** 添加人员 [SrvUser] ${basePath}${proname}/permissions/user_tree.do **/
        public M csmAdder(Object csmAdder) {
            this.put("csmAdder", csmAdder);
            return this;
        };

        /** and csm_adder is null */
        public M csmAdderNull() {
            if (this.get("csmAdderNot") == null)
                this.put("csmAdderNot", "");
            this.put("csmAdder", null);
            return this;
        };

        /** not .... */
        public M csmAdderNot() {
            this.put("csmAdderNot", "not");
            return this;
        };

        /** 跟踪人员 [SrvUser] ${basePath}${proname}/permissions/user_tree.do **/
        public M csmTracker(Object csmTracker) {
            this.put("csmTracker", csmTracker);
            return this;
        };

        /** and csm_tracker is null */
        public M csmTrackerNull() {
            if (this.get("csmTrackerNot") == null)
                this.put("csmTrackerNot", "");
            this.put("csmTracker", null);
            return this;
        };

        /** not .... */
        public M csmTrackerNot() {
            this.put("csmTrackerNot", "not");
            return this;
        };

        /** 推荐会员 [CsMember] **/
        public M csmRefer(Object csmRefer) {
            this.put("csmRefer", csmRefer);
            return this;
        };

        /** and csm_refer is null */
        public M csmReferNull() {
            if (this.get("csmReferNot") == null)
                this.put("csmReferNot", "");
            this.put("csmRefer", null);
            return this;
        };

        /** not .... */
        public M csmReferNot() {
            this.put("csmReferNot", "not");
            return this;
        };
        ...
        /** 推荐方式 0:无 1:地址转发 2:微博分享 3:广告媒体 4:网络搜索 5:朋友推荐 6:活动推广 **/
        public M csmReferType(Object csmReferType) {
            this.put("csmReferType", csmReferType);
            return this;
        };

        /** and csm_refer_type is null */
        public M csmReferTypeNull() {
            if (this.get("csmReferTypeNot") == null)
                this.put("csmReferTypeNot", "");
            this.put("csmReferType", null);
            return this;
        };

        /** not .... */
        public M csmReferTypeNot() {
            this.put("csmReferTypeNot", "not");
            return this;
        };

        /** 注册平台 0:后台 1:网站 2:微信 3:APP 4:支付宝微生活 **/
        public M csmFrom(Object csmFrom) {
            this.put("csmFrom", csmFrom);
            return this;
        };

        /** and csm_from is null */
        public M csmFromNull() {
            if (this.get("csmFromNot") == null)
                this.put("csmFromNot", "");
            this.put("csmFrom", null);
            return this;
        };

        /** not .... */
        public M csmFromNot() {
            this.put("csmFromNot", "not");
            return this;
        };

        /** 注册源信息 **/
        public M csmSrc(Object csmSrc) {
            this.put("csmSrc", csmSrc);
            return this;
        };

        /** and csm_src is null */
        public M csmSrcNull() {
            if (this.get("csmSrcNot") == null)
                this.put("csmSrcNot", "");
            this.put("csmSrc", null);
            return this;
        };

        /** not .... */
        public M csmSrcNot() {
            this.put("csmSrcNot", "not");
            return this;
        };

        /** 来源渠道 [CsChannel] **/
        public M csmChannel(Object csmChannel) {
            this.put("csmChannel", csmChannel);
            return this;
        };

        /** and csm_channel is null */
        public M csmChannelNull() {
            if (this.get("csmChannelNot") == null)
                this.put("csmChannelNot", "");
            this.put("csmChannel", null);
            return this;
        };

        /** not .... */
        public M csmChannelNot() {
            this.put("csmChannelNot", "not");
            return this;
        };
        ...
        /** 营销方案 [CsMarketPlan] **/
        public M csmMarketPlan(Object csmMarketPlan) {
            this.put("csmMarketPlan", csmMarketPlan);
            return this;
        };

        /** and csm_market_plan is null */
        public M csmMarketPlanNull() {
            if (this.get("csmMarketPlanNot") == null)
                this.put("csmMarketPlanNot", "");
            this.put("csmMarketPlan", null);
            return this;
        };

        /** not .... */
        public M csmMarketPlanNot() {
            this.put("csmMarketPlanNot", "not");
            return this;
        };
        ...
        /** 来源活动 [CsActivity] **/
        public M csmActivity(Object csmActivity) {
            this.put("csmActivity", csmActivity);
            return this;
        };

        /** and csm_activity is null */
        public M csmActivityNull() {
            if (this.get("csmActivityNot") == null)
                this.put("csmActivityNot", "");
            this.put("csmActivity", null);
            return this;
        };

        /** not .... */
        public M csmActivityNot() {
            this.put("csmActivityNot", "not");
            return this;
        };
        ...
        /** 销售人员 [SrvUser] ${basePath}${proname}/permissions/user_tree.do **/
        public M csmSaler(Object csmSaler) {
            this.put("csmSaler", csmSaler);
            return this;
        };

        /** and csm_saler is null */
        public M csmSalerNull() {
            if (this.get("csmSalerNot") == null)
                this.put("csmSalerNot", "");
            this.put("csmSaler", null);
            return this;
        };

        /** not .... */
        public M csmSalerNot() {
            this.put("csmSalerNot", "not");
            return this;
        };

        /**
         * 营销标记 [SrvProperty] 营销标识:'MEMBER_MARKET' select * from srv_property where sp_parent =
         * (select sp_id from srv_property where sp_flag = ?)
         **/
        public M csmMarket(Object csmMarket) {
            this.put("csmMarket", csmMarket);
            return this;
        };

        /** and csm_market is null */
        public M csmMarketNull() {
            if (this.get("csmMarketNot") == null)
                this.put("csmMarketNot", "");
            this.put("csmMarket", null);
            return this;
        };

        /** not .... */
        public M csmMarketNot() {
            this.put("csmMarketNot", "not");
            return this;
        };
         ...
         * where sp_parent = (select sp_id from srv_property where sp_flag = ?)
         **/
        public M csmTag(Object csmTag) {
            this.put("csmTag", csmTag);
            return this;
        };

        /** and csm_tag is null */
        public M csmTagNull() {
            if (this.get("csmTagNot") == null)
                this.put("csmTagNot", "");
            this.put("csmTag", null);
            return this;
        };

        /** not .... */
        public M csmTagNot() {
            this.put("csmTagNot", "not");
            return this;
        };
         ...
         * srv_property where sp_parent = (select sp_id from srv_property where sp_flag = ?)
         **/
        public M csmMark(Object csmMark) {
            this.put("csmMark", csmMark);
            return this;
        };

        /** and csm_mark is null */
        public M csmMarkNull() {
            if (this.get("csmMarkNot") == null)
                this.put("csmMarkNot", "");
            this.put("csmMark", null);
            return this;
        };

        /** not .... */
        public M csmMarkNot() {
            this.put("csmMarkNot", "not");
            return this;
        };

        /**
         * 回访标记 [CsQuestTemplate] (回访标记)对应回访模板,勾上了表示该模板已调查或已回访 select * from cs_quest_template where
         * 1=1
         **/
        public M csmVisitFlag(Object csmVisitFlag) {
            this.put("csmVisitFlag", csmVisitFlag);
            return this;
        };

        /** and csm_visit_flag is null */
        public M csmVisitFlagNull() {
            if (this.get("csmVisitFlagNot") == null)
                this.put("csmVisitFlagNot", "");
            this.put("csmVisitFlag", null);
            return this;
        };

        /** not .... */
        public M csmVisitFlagNot() {
            this.put("csmVisitFlagNot", "not");
            return this;
        };

        /** 程序掩码 1:已回流支付宝 2:保留2 4:保留4 8:保留8 (程序标记)技术人员使用的标记，按位运算 **/
        public M csmMask(Object csmMask) {
            this.put("csmMask", csmMask);
            return this;
        };

        /** and csm_mask is null */
        public M csmMaskNull() {
            if (this.get("csmMaskNot") == null)
                this.put("csmMaskNot", "");
            this.put("csmMask", null);
            return this;
        };

        /** not .... */
        public M csmMaskNot() {
            this.put("csmMaskNot", "not");
            return this;
        };

        /** 备注 **/
        public M csmRemark(Object csmRemark) {
            this.put("csmRemark", csmRemark);
            return this;
        };

        /** and csm_remark is null */
        public M csmRemarkNull() {
            if (this.get("csmRemarkNot") == null)
                this.put("csmRemarkNot", "");
            this.put("csmRemark", null);
            return this;
        };

        /** not .... */
        public M csmRemarkNot() {
            this.put("csmRemarkNot", "not");
            return this;
        };

        /** 手机认证 0:未认证 1:已认证 2:等待认证 3:认证失败 **/
        public M csmVMobile(Object csmVMobile) {
            this.put("csmVMobile", csmVMobile);
            return this;
        };

        /** and csm_v_mobile is null */
        public M csmVMobileNull() {
            if (this.get("csmVMobileNot") == null)
                this.put("csmVMobileNot", "");
            this.put("csmVMobile", null);
            return this;
        };

        /** not .... */
        public M csmVMobileNot() {
            this.put("csmVMobileNot", "not");
            return this;
        };

        /** 邮箱认证 0:未认证 1:已认证 2:等待认证 3:认证失败 **/
        public M csmVEmail(Object csmVEmail) {
            this.put("csmVEmail", csmVEmail);
            return this;
        };

        /** and csm_v_email is null */
        public M csmVEmailNull() {
            if (this.get("csmVEmailNot") == null)
                this.put("csmVEmailNot", "");
            this.put("csmVEmail", null);
            return this;
        };

        /** not .... */
        public M csmVEmailNot() {
            this.put("csmVEmailNot", "not");
            return this;
        };

        /** 实名认证 0:未认证 1:已认证 2:等待认证 3:认证失败 **/
        public M csmVReal(Object csmVReal) {
            this.put("csmVReal", csmVReal);
            return this;
        };

        /** and csm_v_real is null */
        public M csmVRealNull() {
            if (this.get("csmVRealNot") == null)
                this.put("csmVRealNot", "");
            this.put("csmVReal", null);
            return this;
        };

        /** not .... */
        public M csmVRealNot() {
            this.put("csmVRealNot", "not");
            return this;
        };

        /** 驾驶认证 0:未认证 1:已认证 2:等待认证 3:认证失败 **/
        public M csmVDrive(Object csmVDrive) {
            this.put("csmVDrive", csmVDrive);
            return this;
        };

        /** and csm_v_drive is null */
        public M csmVDriveNull() {
            if (this.get("csmVDriveNot") == null)
                this.put("csmVDriveNot", "");
            this.put("csmVDrive", null);
            return this;
        };

        /** not .... */
        public M csmVDriveNot() {
            this.put("csmVDriveNot", "not");
            return this;
        };


        /** 工作认证 0:未认证 1:已认证 2:等待认证 3:认证失败 **/
        public M csmVWork(Object csmVWork) {
            this.put("csmVWork", csmVWork);
            return this;
        };

        /** and csm_v_work is null */
        public M csmVWorkNull() {
            if (this.get("csmVWorkNot") == null)
                this.put("csmVWorkNot", "");
            this.put("csmVWork", null);
            return this;
        };

        /** not .... */
        public M csmVWorkNot() {
            this.put("csmVWorkNot", "not");
            return this;
        };

        /** 线下认证 0:未认证 1:已认证 2:等待认证 3:认证失败 **/
        public M csmVOffline(Object csmVOffline) {
            this.put("csmVOffline", csmVOffline);
            return this;
        };

        /** and csm_v_Offline is null */
        public M csmVOfflineNull() {
            if (this.get("csmVOfflineNot") == null)
                this.put("csmVOfflineNot", "");
            this.put("csmVOffline", null);
            return this;
        };

        /** not .... */
        public M csmVOfflineNot() {
            this.put("csmVOfflineNot", "not");
            return this;
        };

        /** 禁用原因 **/
        public M csmLockReason(Object csmLockReason) {
            this.put("csmLockReason", csmLockReason);
            return this;
        };

        /** and csm_lock_reason is null */
        public M csmLockReasonNull() {
            if (this.get("csmLockReasonNot") == null)
                this.put("csmLockReasonNot", "");
            this.put("csmLockReason", null);
            return this;
        };

        /** not .... */
        public M csmLockReasonNot() {
            this.put("csmLockReasonNot", "not");
            return this;
        };

        /** 线下认证机器编码 **/
        public M csmVOfflineCode(Object csmVOfflineCode) {
            this.put("csmVOfflineCode", csmVOfflineCode);
            return this;
        };

        /** and csm_v_offline_code is null */
        public M csmVOfflineCodeNull() {
            if (this.get("csmVOfflineCodeNot") == null)
                this.put("csmVOfflineCodeNot", "");
            this.put("csmVOfflineCode", null);
            return this;
        };

        /** not .... */
        public M csmVOfflineCodeNot() {
            this.put("csmVOfflineCodeNot", "not");
            return this;
        };

        /** 可用状态 [非空] 1:正常 0:禁用 -1:黑名单 **/
        public M csmStatus(Object csmStatus) {
            this.put("csmStatus", csmStatus);
            return this;
        };

        /** and csm_status is null */
        public M csmStatusNull() {
            if (this.get("csmStatusNot") == null)
                this.put("csmStatusNot", "");
            this.put("csmStatus", null);
            return this;
        };

        /** not .... */
        public M csmStatusNot() {
            this.put("csmStatusNot", "not");
            return this;
        };
        ...
        public M definex(String sql) {
            this.put("definex", sql);
            return this;
        }
        ...
        public @api void update() {
            ...
            if (this.type == 0) {
                if (this.linked == null)
                    throw new RuntimeException("未发set");
                where = this;
                set = this.linked;
            } else {
                if (this.linked == null)
                    throw new RuntimeException("未发where条件");
                set = this;
                where = this.linked;
            }
    ...
    public static class F {
        ...
        /** and csm_first_recharge >= ? */
        public final static @type(Date.class) String csmFirstRechargeStart =
                "csmFirstRechargeStart";
        /** and csm_first_recharge <= ? */
