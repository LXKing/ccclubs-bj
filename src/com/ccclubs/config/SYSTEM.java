...
public class SYSTEM {
	...
	public enum RuleName {
		工作日白天小时, 工作日晚上小时, 双休日白天小时, 双休日晚上小时, 节假日白天小时, 节假日晚上小时, 工作日一天, 工作日白天包段, 工作日晚上包段, 双休日一天, 双休日白天包段, 双休日晚上包段, 节假日一天, 节假日白天包段, 节假日晚上包段, 每次,每天, 每小时, 每分钟, 每公里,晚上包段,白天小时,晚上小时,白天包段
	}
