 ...
 * 
 */
public class CarStatusII extends CStruct implements ICarStatus {
	...
	public CarStatusII(String mCarNum) {
		// TODO Auto-generated constructor stub
		this.mFucCode = 0x41;
	 ...
	 * @return
	 */
	public static String getInsertSql(String table, CarStatusII carStatus, int connectType, String host) {
		...
		switch (connectType) {
			...
			case 1:
				// 
				sb.append("cshs_number,cshs_add_time,cshs_rented,cshs_rfid,cshs_speed,cshs_motor,cshs_oil,cshs_power,cshs_mileage,cshs_longitude,cshs_latitude,cshs_order,cshs_host,cshs_warn,cshs_temperature,cshs_csq,cshs_current_time,cshs_rfid_dte,cshs_obd_mile,cshs_engine_t)");
				break;
		}
	 ...
	 * @return
	 */
	public static String getUpdateSql(String table, CarStatusII carStatus, String host) {
		StringBuilder sb = new StringBuilder();
		// String table = "cs_log";
