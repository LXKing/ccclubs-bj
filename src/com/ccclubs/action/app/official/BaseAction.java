...
public class BaseAction {
    ...
    public Map<String, Object> defaultArea() {
        ...
        List<CsUnitInfo> unitList =
                CsUnitInfo.getCsUnitInfoList($.add(CsUnitInfo.F.csuiName, "北京市政务中心"), -1);
     ...
     * @return
     */
    public CsMember getRegisterMember(CsMember csMember, String csmPassword, short from,
            String csmMobile, String inviteCode) {
    ...
    public CsMember updateMember(CsMember csMember, String realName, Long host, String unitName) {
        ...
        csMember.setCsmRemark("{\"remark\":\"" + csMember.getCsmRemark() + "\",\"unitName\":\""
                + unitName + "\"}");
        return csMember;
    }
     ...
     * 修改会员实名认证状态
     */
    public CsMember updateAutoState(CsMember member, Short vDriveState, Short vIdCardState,
            Short vWorkState) {
