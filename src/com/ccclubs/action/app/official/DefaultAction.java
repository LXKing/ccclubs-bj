...
public class DefaultAction extends BaseAction {
    ...
    public String submitPersonalOrder() {
        ...
        if(takeTime.getTime()-new Date().getTime()>30*60*1000||takeTime.getTime()-new Date().getTime()<0){
...
//            }
            ...
            if (conType.equals("1")) { // 取车/开门
                ...
                //提示用户先取车
                if(csOrder.getCsoStatus().equals(new Short("0"))){
                    return returnError("106", "请先取车");
                }
                
                //有取车动作才能还车
                if (csOrder.getCsoStatus().equals(new Short("1"))) {
