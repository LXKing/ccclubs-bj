...
public class PenglongAppJpushTest {
	
    protected static final Logger LOG = LoggerFactory.getLogger(PenglongAppJpushTest.class);
...
//                 .setAudience(Audience.all())
                 .setAudience(Audience.tag("10014169"))
                 .setNotification(Notification.android("消息正俄文", "提示", null))
                 .build();
    }
